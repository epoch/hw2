...
admin = User.create(:name => 'admin', :password => 'admin', :password_confirmation => 'admin', :image =>"http://upload.wikimedia.org/wikipedia/lv/1/14/Ralph_Wiggum.png", :is_admin => true)
