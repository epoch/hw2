...
originStation = $('.station-list');
departFrom = $originStation.options[$originStation.selectedIndex];
...
var changeLines;
  ...
  if (currentLine === destinationLine) {
    ...
    $('.change-lines').text('You will not be required to change lines on this journey.');
  ...
  $('change-lines').text('You will need to change to line ' + destinationLine + ' at Union Square.');
